...
- Dashboard дээрээс `Сарын өртөг / Historical` module-ийг түр нуусан. Historical дата дараагийн шатанд ашиглагдана.
- Тайлан илгээх flow өөрчлөгдсөн: ажилтан эхлээд хэсгээ сонгоно, PIN баталгаажсаны дараа тухайн form нээгдэнэ.
- Пүүний мэдээлэл тээвэр module-ийн дэд хэсэг хэвээр байна.
